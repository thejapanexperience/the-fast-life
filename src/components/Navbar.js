  ...
  render() {
    ...
    return (
      ...
      <div className="text-center">
        ...
        {authenticated ? <Link to={'/'}><FlatButton onClick={this._signOut} label="Sign Out" primary style={{ width: '25%', padding: '2px' }} /></Link> : <Link to={'/'}><FlatButton label="Login" secondary style={{ width: '25%', padding: '2px' }} /></Link>}
