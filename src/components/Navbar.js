  ...
  render() {
    ...
    return (
      ...
      <div className="text-center">
        ...
        {authenticated ? <Link to={'/'}><FlatButton className="navButtons" label="Fast Life" primary style={{ width: '25%', padding: '2px' }} /></Link> : <Link to={'/'}><FlatButton className="navButtons" label="The Fast Life" secondary style={{ width: '25%', padding: '2px' }} /></Link>}

        {authenticated ? <Link to={'/myfasts'}><FlatButton className="navButtons" label="My Fasts" primary style={{ width: '25%', padding: '2px' }} /></Link> : <Link to={'/'}><FlatButton className="navButtons" disabled label=" " secondary style={{ width: '25%', padding: '2px' }} /></Link>}
